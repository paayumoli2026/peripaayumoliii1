...
import connection from "../assets/eventdetails/connection.jpeg";
import boxcricket from "../assets/eventdetails/boxcricket.jpeg";
import cinequiz from "../assets/eventdetails/cinequiz.jpeg";
...
import duelsinging from "../assets/eventdetails/duelsinging.jpeg";
import beatboxing from "../assets/eventdetails/beatboxing.jpeg";
import dancebattle from "../assets/eventdetails/dancebattle.jpeg";
import treasurehunt from "../assets/eventdetails/treasurehunt.jpeg";
import brandwar from "../assets/eventdetails/brandwar.jpeg";
...
export const viewEventDetails = {
  ...
  duelsinging: {
    ...
    brief:
      "A duel singing competition where participants showcase their vocal range, pitch, and stage presence.",
    poster: duelsinging,
    url: "duelsinging",
    eventDetails: {
      time: "-",
    ...
    rules: [
      "Each participant has a total time of 3 mins",
  ...
  mehandi: {
    ...
    rules: [
      "Participants will be given 1 hour to complete their Mehendi design (theme-based or free style).",
  ...
  beatboxing: {
    ...
    description: "Unleash your vocal potential and mesmerize the audience!",
    brief:
      "A dynamic sound clash where performers create powerful beats using only their voice and technique.",
    poster: beatboxing,
    url: "beatboxing",
    eventDetails: {
      time: "-",
    ...
    rules: [
      ...
      "No background music or instruments allowed.",
      "Participants must use only vocal sounds.",
      "Judging based on rhythm, clarity, creativity, and stage performance.",
    ],
  },
  corporatewalk: {
    category: "intra",
