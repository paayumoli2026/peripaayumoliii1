        ...
        <section id="features" className="py-24 px-6 bg-transparent relative">
            <div className="max-w-7xl mx-auto space-y-16">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-orange-100/85 max-w-2xl mx-auto font-medium">
                        ...
                        >
                            ...
                            <div className="space-y-6 relative z-10">
                                ...
                                <div className="space-y-3">
                                    <h3 className="text-2xl font-bold text-[#ffe2c2] tracking-tight">
                                        {feature.title}
                                    </h3>
                                    <p className="text-orange-200/75 leading-relaxed text-sm">
                                        {feature.description}
                                    </p>
                                </div>
                            </div>
