...
const ClgEventscard = ({ imageUrl, eventName, url }) => {
  ...
  return (
    ...
    >
      <div className="relative w-full h-80 sm:h-64 md:h-80 overflow-hidden rounded-[24px] border border-orange-200/25 bg-[#120905] transition-all duration-500 group-hover:shadow-[0_22px_52px_-16px_rgba(255,95,0,0.45)]">
        {/* Image */}
        <img
          src={imageUrl}
          alt={eventName}
