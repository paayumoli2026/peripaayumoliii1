...
const ClgEventscard = ({ imageUrl, eventName, subtitle }) => {
  return (
    <Link
      to={`/${eventName.toLowerCase().replace(/\s+/g, "")}`}
      className="block group"
    >
      <div className="relative w-64 sm:w-80 md:w-96 h-96 sm:h-[450px] md:h-[500px] overflow-hidden rounded-[32px] border border-orange-200/25 bg-[#120905] transition-all duration-500 group-hover:shadow-[0_22px_54px_-16px_rgba(255,95,0,0.5)]">
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-8 z-20">
          <div className="space-y-4">
            ...
            {subtitle && (
              <div className="text-[10px] sm:text-xs font-black uppercase tracking-[0.35em] text-orange-100/90">
                {subtitle}
              </div>
            )}
