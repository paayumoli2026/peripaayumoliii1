    ...
    <div className="relative flex flex-col items-center justify-center min-h-screen text-center px-6 pt-32 pb-20 overflow-hidden bg-transparent">
      ...
      >
        <img
          src={gglogotemp}
          alt="Background Logo"
          className="absolute top-[40%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200%] h-auto max-w-[750px] object-contain opacity-50 pointer-events-none -z-10"
        />

        {/* Blended Title Branding */}
        <div className="space-y-2">
          <p className="text-sm font-bold tracking-[0.3em] uppercase text-[#ffd5a0] drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
        ...
        {/* Date Section */}
        <div className="text-xl sm:text-2xl font-black text-orange-100 tracking-wide drop-shadow-[0_2px_10px_rgba(0,0,0,0.85)]">
