  ...
  return (
    <div className="w-full flex flex-col items-center space-y-12">
      <div className="text-center space-y-4">
        ...
        <p className="text-gray-900 max-w-2xl mx-auto font-black italic">
          {isIntracollege
      ...
      <div className="relative w-full max-w-[500px] group">
        <input
          ...
          className="w-full px-6 py-4 text-lg text-black glass-card border-2 border-transparent focus:border-[var(--color-brand-primary)]/50 outline-none transition-all duration-300 placeholder:text-gray-500 font-black text-center"
        />
    ...
    >
      {filteredEvents.length > 0 ? (
        ...
        <div className="col-span-full py-20 text-center space-y-4">
          <p className="text-2xl font-black text-gray-950 italic">No events match your quest</p>
